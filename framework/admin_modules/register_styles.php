...
function ihbp_scripts() {
	...
	wp_enqueue_style('-title-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('ihbp_title_font', 'Ovo') ).':100,300,400,700' );
	
	wp_enqueue_style('-body-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('ihbp_body_font', 'Quattrocento Pro') ).':100,300,400,700' );
